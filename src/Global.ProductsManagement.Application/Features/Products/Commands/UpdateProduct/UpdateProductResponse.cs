...
namespace Global.ProductsManagement.Application.Features.Products.Commands.UpdateProduct
{
    ...
    {
        public UpdateProductResponse(Guid id, string name, string details, double price,
            DateTime createDate, DateTime? updateDate, Guid categoryId, EProdutoStatus status, Guid brandId)
        {
            Id = id;
            Name = name;
            Details = details;
